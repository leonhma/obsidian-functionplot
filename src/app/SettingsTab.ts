    ...
    display() {
        ...
        new Setting(containerEl)
            ...
            .addText((text) => {
                ...
                text.setValue(this.plugin.settings.fontColor).onChange(
                    async (value) => {
        ...
        new Setting(containerEl)
            ...
            .addText((text) => {
                ...
                text.setValue(this.plugin.settings.lineColor).onChange(
                    async (value) => {
        ...
        new Setting(containerEl)
            ...
            .addText((text) => {
                ...
                text.setValue(this.plugin.settings.gridColor).onChange(
                    async (value) => {
